...
public class TeamServiceImpl implements TeamService {
    ...
    public void joinTeam(Long teamId, com.tournament.engine.modules.tournament.dto.JoinTeamRequest request) {
        ...
        if (request.getInGameName() == null || !request.getInGameName().matches("^.+#.+$")) {
            throw new RuntimeException("Tên trong game (IGN) phải đúng định dạng Riot ID, bao gồm dấu # (VD: TuanBro#VN1)");
        }
